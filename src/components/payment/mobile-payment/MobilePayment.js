...
class Payment extends React.Component{
    ...
    componentDidMount() {
        const URL_GET_AMOUNT = "http://40.115.93.16:8080/api/postman/last";
    ...
    submitPayment = (event) => {
        ...
        const URL_MOBILEPAYENT_GATEWAY = "http://40.127.80.241:8080/tls-pay/api/makePayment";
